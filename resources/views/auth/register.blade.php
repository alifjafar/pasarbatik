        ...
        <div class="container ">
            <div class="row">
                <div class="col text-center mt-5">
                    <div class="brand-pasarbatik brand-md"><a href="{{ route('homepage') }}">PasarBatik</a></div>
                    <br>
                ...
                <div class="col-md-4 offset-md-4 mt-5 ">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="gender" value="2" id="gWoman"
                                       class="custom-control-input" {{ (old('gender') == 2) ? 'checked' : '' }} >
                                <label class="custom-control-label" for="gWoman">Perempuan</label>
                            </div> @if ($errors->has('gender'))
                                <small class="text-warning">{{ $errors->first('gender') }}</small>
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @if ($errors->has('username'))
                                <div id="error-username">
                                    <small class="text-warning">{{ $errors->first('username') }}</small>
                                </div>
                            @endif
                        </div>
                        <div class="form-group">
                        ...
                        <p>Dengan klik daftar, kamu telah menyetujui <strong><a href="#">Aturan Penggunaan</a></strong>
                            dan <strong><a href="#">Kebijakan Privasi</a></strong> dari <span
                                class="font-pasarbatik color-pasarbatik">PasarBatik</span>.</p>
